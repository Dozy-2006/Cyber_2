      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md border-t-4 border-indigo-600">
        ...
        */}
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Username Input */}
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-1">Username (Full Name)</label>
            <input
              type="text"
              placeholder="e.g. Officer John"
              value={username}
              onChange={(e) => setUsername(e.target.value)}
              className="w-full border border-gray-300 p-3 rounded focus:ring-2 focus:ring-indigo-500 outline-none transition-all"
            />
          </div>
